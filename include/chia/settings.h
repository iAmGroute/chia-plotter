...
constexpr int G_P1T1_P1T1_WRITE_THREADS = 12; // tot /2 | tot /2

constexpr int G_P1_P1_SORT_THREADS      = 12; // tot /2 | tot /2
constexpr int G_P1_P1_READ_THREADS      = 12; // sort   | sort/2
constexpr int G_P1_MATCH_THREADS        = 24; // tot    | tot
constexpr int G_P1_EVAL_THREADS         = 24; // tot    | tot
constexpr int G_P1_P1_WRITE_THREADS     = 12; // tot /2 | tot /2

constexpr int G_P2_P1F_READ_THREADS     =  2; // 2      | tot /4
...
constexpr int G_P2_P2_WRITE_THREADS     = 12; // tot /2 | tot /2

constexpr int G_P3S1_P1T1F_READ_THREADS =  2; // 2      | tot /4
...
constexpr int G_P3S2_P3S1_READ_THREADS  = 12; // sort/2 | sort/2
constexpr int G_P3S2_P3S2_WRITE_THREADS = 12; // tot /2 | tot /2
constexpr int G_P3S2_F_PARK_THREADS     = 12; // tot /2 | tot /2

constexpr int G_P4_P3S2_SORT_THREADS    = 24; // tot    | tot
constexpr int G_P4_P3S2_READ_THREADS    = 12; // sort/2 | sort/2
